...
# ╔═╡ fe6e810c-657b-4d00-ae4f-3ca820137ec3
begin
	using StaticArrays
	using PlutoUI
	import Base: +, *
...
# ╔═╡ 5eed8666-5a19-4951-99ef-2c5fc777c63f
struct Dual{T} <:Number
    val::T   # value
    der::T  # derivative
end

# ╔═╡ 9d309a8c-a4a5-401f-bfaa-d84ff00cdb07
struct MultiDual{N,T}<:Number # N-> Size of the vector, T -> DataType of the vector
    val::T
    derivs::SVector{N,T}
end

# ╔═╡ c12f1645-a870-4ac8-b862-37b9aeff0833
begin
    function Base.show(io::IO, ::MIME"text/plain", a::MultiDual{N,T}) where {N,T}
        println(io, "MultiDual with datatype $T")
        println(io, "val => ", a.val, "\nderiv => ", a.derivs)
    end
end

# ╔═╡ bc0b2678-8176-4981-9cc7-ca71c248a076
begin
	import Base: convert
...
# ╔═╡ a2b0fd92-a4f0-41d1-88b6-0ef6206926ae
begin
...
# ╔═╡ ddd5ff36-1671-4a22-8b5c-81e587db56b0
begin
...
# ╔═╡ f05ccd5f-6156-4b92-8886-101c97cbbcb7
