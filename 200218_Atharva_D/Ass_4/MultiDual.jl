...
# ╔═╡ 1c7b2fec-e4cf-11eb-1694-43e6614e6707
begin
	using StaticArrays
	using PlutoUI
	import Base: +, *
	using Distributions, Random, Plots, StatsPlots, Parameters, PlotlyBase
	plotly()
end

# ╔═╡ fb8a0d74-2da1-4900-bfa1-90a15a7cb2fb
md"""
...
We want to extend it such that it has functions for-

- `^`(non-integral powers too), `+`, `-`, `*`, `/`
- `abs` : Absolute Value
- `sin`, `cos`
- `exp` : Exponential
- `log`
...
md"""
## `show` method to display MultiDuals nicely
"""

# ╔═╡ 636f97fa-0748-41cf-9ec5-9a23a7172f1f
begin
	function Base.show(io::IO, ::MIME"text/plain", x::MultiDual{N,T}) where {N,T}
		println(io, "The given MultiDual with eltype $T can be depicted as...")
		println(io, "Its val is ", x.val, " and deriv is ", x.derivs)
	end
	z = MultiDual(7.0, SVector(3.0,4.0))
end

# ╔═╡ 69cbf3b7-5179-4806-b5a2-4004ad2dd2c7
md"""
## Comparisons
- Comparing a MultiDual and a Number
- Comparing 2 MultiDuals
  using `>`, `<`, `==`
...
Create a wrapper for Gradient in MultiDual. We had earlier made a derivative wrapper for Dual
"""
